...
function renderButtons() {
  ...
  //Select all the buttons and iterate over them using mapping of innerHTML with state keys 
  document.querySelectorAll('.btn').forEach(function($btn){
    let value=$btn.innerHTML; 
    if (state[getKeyByValue(ingredients, value)]){
...
//get the Key of ingredient depending on it's name (inner HTML of the btn )
...
function renderPrice() {
  ...
  Object.keys(state).forEach(function(key){
    ...
    if(state[key]){
      ...
      document.getElementById(key).style.display='list-item';
    } else {
