...
function renderButtons() {
  ...
  renderButton(state.pepperonni, $btnPepperonni);
  renderButton(state.mushrooms, $btnMushrooms);
  renderButton(state.greenPeppers, $btnGreenPeppers);
  renderButton(state.whiteSauce, $btnSauce);
